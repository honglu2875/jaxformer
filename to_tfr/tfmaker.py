...
def get_files(input_path: Path) -> List[str]:
    print(input_path)
    # input_path=Path("/fsx/home-harrysaini/projects/codegen_fin/output.txt")
    input_path=Path("/fsx/home-harrysaini/projects/codegen_fin/diff_dataset/data_0_time1668263450_default.jsonl.zst")
    ...
    if input_path.is_dir():
        ...
        raise FileNotFoundError(f"No such file or directoryz: {input_path}")
